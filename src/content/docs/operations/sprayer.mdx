...
As the SPRAY MODE toggle switch indicates, there are two possible modes for the boom spray:
...
The coverage rate is dependent upon the choice of nozzle tip as well as the spray system pressure. 

Coming soon: Spray rate chart
